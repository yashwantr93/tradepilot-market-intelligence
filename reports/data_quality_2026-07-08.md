# Data Quality Report — 2026-07-08

_Swing Trading Intelligence System — Rule-based swing-trade research · ~1–8 week horizon · no AI / no scoring / no buy-sell calls_

## Coverage

- Deal symbols discovered: **31**
- Symbols with price history (yfinance): **26**
- Symbols missing price data: **5**
- Sectors resolved: **21** / 31

## Validation

- Bulk deal rows ingested: **170**
- Block deal rows ingested: **2**
- Rows quarantined (dead-letter): **0**

## Watchlist field completeness

- Rows with missing current price: **2**
- Rows with Unknown sector: **3**
- Rows with missing 52W-high distance: **2**
