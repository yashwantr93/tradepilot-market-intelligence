# FII/DII + Sector Rotation — Validation Report (2026-07-08)
...
- FII/DII rows stored: **1** (history depth: 7 session(s))
...
| --- | --- | --- | --- | --- | --- | --- |
| Banking | 3.99 | 0.26 | N | Y | Improving | index |
| Financial Services | 5.66 | 1.93 | Y | Y | Improving | index |
| IT | -3.0 | -6.72 | N | N | Weak | index |
| Auto | 2.2 | -1.53 | Y | Y | Neutral | index |
| Pharma | 6.92 | 3.19 | Y | Y | Strong | index |
| FMCG | 2.53 | -1.19 | Y | N | Neutral | index |
| Capital Goods | 2.16 | -1.57 | Y | Y | Neutral | proxy |
| Defence | 5.08 | 1.35 | N | N | Improving | basket |
| Realty | 16.04 | 12.32 | Y | Y | Strong | index |
| PSU | -2.54 | -6.27 | N | N | Weak | index |
| Energy | -3.4 | -7.12 | N | N | Weak | index |
| Metals | -5.68 | -9.41 | N | N | Weak | index |
